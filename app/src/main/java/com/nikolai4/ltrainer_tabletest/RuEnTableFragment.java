...
import com.nikolai4.ltrainer_tabletest.model.competition.RuEnTable;
 ...
 * Use the {@link RuEnTableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RuEnTableFragment extends Fragment {
    ...
    private List<TextView> answerButtons = new ArrayList<>(4);
     ...
     * @return A new instance of fragment FirstTableFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RuEnTableFragment newInstance(String param1, String param2) {
        RuEnTableFragment fragment = new RuEnTableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_ru_en_table, container, false);
    }
...
//        competitionViewModel = ViewModelProviders.of(requireActivity()).get(CompetitionViewModel.class);
        ...
        competitionViewModel.getLiveDataCompetition().observe(getViewLifecycleOwner(), c -> {
            if (c.getCurrentTable() instanceof RuEnTable) {
                RuEnTable table = c.getRuEnTable();
    ...
    public void setNextClickListener(TextView nextText, Competition competition) {
        ...
        nextText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RuEnTable table = competition.getRuEnTable();
                FragmentState.RuEnState state = table.getFragmentState();
                ...
                if (!state.isAnswered()) {
                    ...
                    if (competition.getCurrentTable() instanceof RuEnTable) {
        ...
        for (int i = 0; i < buttons.size(); i++) {
            ...
            currentButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String rightAnswer = table.getRightAnswer();
                    String usersAnswer;
                    FragmentState.RuEnState state = competition.getRuEnTable().getFragmentState();
                    Word currentWord;
    ...
    private void tieDataToViews(RuEnTable table) {
        FragmentState.RuEnState state = table.getFragmentState();
    ...
    private void setViews(View view) {
        answerText1 = view.findViewById(R.id.answer_1_ruen_training);
        answerText2 = view.findViewById(R.id.answer_2_ruen_training);
        answerText3 = view.findViewById(R.id.answer_3_ruen_training);
        answerText4 = view.findViewById(R.id.answer_4_ruen_training);
        examplesText = view.findViewById(R.id.examples_ruen_training);
        nextText = view.findViewById(R.id.next_ruen_training);
    }
